                ...
                return (
                  ...
                  >
                    ...
                    <TableCell component="th" id={labelId} scope="row" padding="none">
                      {row?.OrderId} {/* Adjusted for both platforms */}
                    </TableCell>
                    <TableCell>{row?.SalesChannel || "Unknown"}</TableCell> {/* Default to "Unknown" if not provided */}
                    <TableCell>{new Date(row?.PurchaseDate).toLocaleDateString()}</TableCell>
                    <TableCell sx={{ color: getStatusColor(row?.OrderStatus) }}>{row?.OrderStatus}</TableCell>
