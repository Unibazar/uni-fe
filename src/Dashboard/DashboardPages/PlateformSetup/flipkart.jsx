...
export default function Flipkart() {
  return (
    <div className="flex flex-col items-center space-y-6 p-6 bg-gray-100 min-h-screen">
      {/* Title Section */}
      <h2 className="text-2xl font-bold text-gray-800">How to Link Your Platform: Flipkart</h2>
      ...
      <div className="w-full max-w-lg p-4 space-y-4 bg-white rounded-lg shadow-md">
        ...
        <p className="text-gray-700">
          1. Go to Flipkart Seller Hub and log in to your account.
        </p>
        <p className="text-gray-700">
          2. Navigate to the 'Account Settings' and find the API section.
        </p>
        <p className="text-gray-700">
